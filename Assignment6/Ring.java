...
public class Ring {
    ...
    void initElection(int process_id) {
        if(processes[process_id-1]) {
            pid.add(process_id);    //add active process's id into the pid arraylist
            ...
            while(temp != process_id - 1) {
                if(processes[temp]) {
                    pid.add(temp+1);    //addingg next process to array list
        ...
        while(true) {
            ...
            switch(choice) {
                ...
                case 7:
                    ...
                    // process_id = sc.nextInt();
                    // ring.displayArrayList(Arrays.asList(1, 2, 3, 4, 5));
                    ring.displayArrayList(null);
                    break;
                default:
